...
function EF_Contacts_Pt1(aImarisApplicationID)
...
%Localize spots
        XT = EasyXT(0);
        channel = 1;
        newSpots = XT.DetectSpots(channel, 'Name', 'E2-Syp', ...
                                  'Diameter XY', 0.8, ...
                                  'Spots Filter', '"Quality" above 27.6' ...
                         );
...
%Detect Surface
        XT = EasyXT(0);
        channel = 2;
        surface = XT.DetectSurfaces(channel, 'Name', 'Iba1', ...
                                   'Smoothing', 0.05, ...
                                   'Threshold', 81.9, ...
                                  'Filter', '"Volume" above 0.01 um^3'...
                                   ); 
